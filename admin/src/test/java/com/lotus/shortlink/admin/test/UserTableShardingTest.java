...
public class UserTableShardingTest {
    ...
    public static final String SQL1 = "CREATE TABLE `t_link_%d` (\n" +
            ...
            ") ENGINE=InnoDB AUTO_INCREMENT=1731699934433918979 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
    ...
    public static final String SQL2 = "CREATE TABLE `t_group_%d` (\n" +
            ...
            ") ENGINE=InnoDB AUTO_INCREMENT=1729873425490509826 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";

    public static final String SQL3 = "CREATE TABLE link.t_link_goto_%d (\n" +
            "\tid BIGINT auto_increment NOT NULL,\n" +
            "\tgid varchar(32) DEFAULT 'default' NULL,\n" +
            "\tfull_short_url varchar(128) NULL,\n" +
            "\tCONSTRAINT t_link_goto_PK PRIMARY KEY (id)\n" +
            ")\n" +
            "ENGINE=InnoDB\n" +
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 16; i++) {
            System.out.println(String.format((SQL3 + "%n"), i));
        }
    }
}
